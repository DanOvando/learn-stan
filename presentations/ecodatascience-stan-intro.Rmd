...
author: "Dan Ovando"
institute: "eco-data-science Seminar"
date: "`r Sys.Date()`"
output:
...
This is a deep topic that we don't' have time to get into! But from an ecological perspective Bayes has some nice features
